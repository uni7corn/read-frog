...
export const testSeries: TestSeriesObject = {
  ...
  "comprehensive-provider-migration-test": {
    description:
      "Test all provider key migrations: gemini→google, grok→xai, amazonBedrock→bedrock, google→google-translate, microsoft→microsoft-translate, openaiCompatible→openai-compatible",
    config: {
      language: {
        sourceCode: "auto",
        targetCode: "cmn",
