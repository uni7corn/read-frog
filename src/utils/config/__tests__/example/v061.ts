...
export const testSeries: TestSeriesObject = {
  "complex-config-from-v020": {
    description:
      "Replaces siteControl mode all with blacklist, splits patterns into independent arrays",
    config: {
      language: {
        sourceCode: "spa",
        targetCode: "eng",
  ...
  "config-with-non-llm-translate-provider": {
    description:
      "translate.providerId is a non-LLM provider; migration should pick first enabled LLM",
    config: {
      language: {
        sourceCode: "spa",
        targetCode: "eng",
