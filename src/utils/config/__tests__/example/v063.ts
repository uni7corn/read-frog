...
export const testSeries: TestSeriesObject = {
  "complex-config-from-v020": {
    description:
      "Adds enabled toggle to selection toolbar built-in features and adds speak feature",
    config: {
      language: {
        sourceCode: "spa",
        targetCode: "eng",
          ...
          patterns: [
            {
              ...
              systemPrompt:
                "Translate into {{targetLang}} with title {{title}} and summary {{summary}}.",
              prompt:
        ...
        customActions: [
          {
            ...
            outputSchema: [
              ...
              },
              {
                ...
                name: "Definition",
                type: "string",
                description: "Explain it in {{targetLang}}.",
                speaking: false,
              },
              {
                id: "coverage-context",
                name: "Context",
                type: "string",
                description: "Reuse {{context}} exactly.",
                speaking: true,
              },
              {
                id: "coverage-notes",
                name: "Notes",
                type: "string",
                description: "Mention {{title}} when relevant.",
                speaking: false,
              },
            ],
          },
          ...
          patterns: [
            {
              ...
              systemPrompt:
                "Translate subtitles into {{targetLang}} with {{title}} and {{summary}} as context.",
              prompt:
                "Title: {{title}}\nSummary: {{summary}}\nTranslate to {{targetLang}}:\n{{input}}",
            },
          ],
...
Target language: {{targetLanguage}}`,
            outputSchema: [
              ...
              },
              {
                ...
                name: "Context",
                type: "string",
                description: "The paragraphs in the prompt above, don't change them.",
                speaking: true,
              },
              {
                ...
                type: "string",
                description: "The translation of the context.",
                speaking: false,
              },
              {
